...
import com.fitzgerald.mvc.controllers.CoinGeckoApi;
...
import com.fitzgerald.mvc.services.CoinGeckoApiService;
...
//        return (CoinFullData) coinGeckoApi.executeSync(coinGeckoApiService.getCoinById(id,localization,tickers,marketData,communityData,developerData,sparkline));
//    }
